...
export const otherRouter = {
    ...
    children: [
        ...
        { path: 'add', title: '添加', name: 'add', component: () => import('@/views/cfpp-vue-template/new-window/add.vue') },
        { path: 'edit', title: '编辑', name: 'edit', component: () => import('@/views/cfpp-vue-template/new-window/edit.vue') },
