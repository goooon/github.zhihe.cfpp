                    ...
                    <Col :md="24" :lg="12" style="padding: 0 5px 10px 0;">
                        <Card>
                            <p slot="title" class="card-title" style="overflow:visible">
                                <a href="http://xpay.exrick.cn/pay?cfpp" target="_blank">
                            ...
                            <div style="height:368px;overflow:auto">
                                ...
                                <div class="flex">
                                    ...
                                    <Button to="http://xpay.exrick.cn/pay?cfpp" target="_blank" type="error" icon="md-paper-plane" style="margin-left:10px;">立即获取</Button>
                                </div>
                                <div class="flex">
                                    商用授权价格：
