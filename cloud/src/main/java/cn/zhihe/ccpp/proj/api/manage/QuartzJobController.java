...
import cn.zhihe.ccpp.proj.task.service.def.IQuartzJobService;
...
public class QuartzJobController {
    ...
    public Result<Page<QuartzJob>> getAll(@ModelAttribute PageVo page){
        ...
        Page<QuartzJob> data = IQuartzJobService.findAll(PageUtil.initPage(page));
    ...
    public Result<Object> pauseJob(@ModelAttribute QuartzJob job){
        ...
        try {
            ...
            throw new CfppException("暂停定时任务失败");
        }
    ...
    public Result<Object> resumeJob(@ModelAttribute QuartzJob job){
        ...
        try {
            ...
            throw new CfppException("恢复定时任务失败");
        }
        job.setStatus(CommonConstant.STATUS_NORMAL);
        IQuartzJobService.update(job);
    ...
    public Result<Object> deleteJob(@PathVariable String[] ids){
        ...
        for(String id:ids){
            QuartzJob job = IQuartzJobService.get(id);
            delete(job.getJobClassName());
            IQuartzJobService.delete(job);
        }
    ...
    public void add(String jobClassName, String cronExpression, String parameter){
        ...
        try {
            ...
            throw new CfppException("创建定时任务失败");
        } catch (Exception e){
            throw new CfppException("后台找不到该类名任务");
        }
    }
    ...
    public void delete(String jobClassName){
        ...
        try {
            ...
            throw new CfppException("删除定时任务失败");
        }
    }
