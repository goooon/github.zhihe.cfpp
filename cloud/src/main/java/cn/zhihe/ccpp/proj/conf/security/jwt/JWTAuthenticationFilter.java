    ...
    private UsernamePasswordAuthenticationToken getAuthentication(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (StrUtil.isNotBlank(token)) {
            ...
            try {
                ...
                throw new CfppException(ExceptionConstant.LOGIN_NOLONGER_VALID);
            } catch (Exception e){
                ResponseUtil.out(response, ResponseUtil.resultMap(false,500, ExceptionConstant.PARSE_TOKEN_FAILED));
            }
        }
        return null;
    }
