package cn.zhihe.ccpp.func.util.generator;

import cn.zhihe.ccpp.func.util.generator.bean.EntityOfEntity;
...
public class XbootGenerator {
     ...
     * 实体类对应包
     */
    private static final String entityPackage = "cn.exrick.xboot.det";
     ...
     * controller对应包
     */
    private static final String controllerPackage = "cn.exrick.xboot.api";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        Template entityTemplate = gt.getTemplate("det.btl");
        ...
        Template controllerTemplate = gt.getTemplate("api.btl");
        ...
        //生成实体类代码
        entityTemplate.binding("det",entity);
        String entityResult = entityTemplate.render();
        log.info(entityResult);
        //创建文件
        String entityFileUrl = System.getProperty("user.dir")+"/src/main/java/cn/exrick/xboot/det/"+className+".java";
        ...
        //生成dao代码
        daoTemplate.binding("det",entity);
        ...
        //生成service代码
        serviceTemplate.binding("det",entity);
        ...
        //生成serviceImpl代码
        serviceImplTemplate.binding("det",entity);
        ...
        //生成controller代码
        controllerTemplate.binding("det",entity);
        String controllerResult = controllerTemplate.render();
        log.info(controllerResult);
        //创建文件
        String controllerFileUrl = System.getProperty("user.dir")+"/src/main/java/cn/exrick/xboot/api/"+className+"Controller.java";
